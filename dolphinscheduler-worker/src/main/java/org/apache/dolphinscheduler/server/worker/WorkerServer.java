...
import org.apache.dolphinscheduler.server.worker.task.TenantCacheTask;
...
public class WorkerServer implements IStoppable {
    ...
    @Autowired
    private TenantCacheTask tenantCacheTask;
